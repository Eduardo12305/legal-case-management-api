...
router.post('/first-access/change-password', authMiddleware, validateRequest({ body: firstAccessPasswordBody }), asyncHandler((req, res) => authController.completeFirstAccess(req, res)));
